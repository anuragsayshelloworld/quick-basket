...
export default function Layout() {
  return (
    <div className="flex flex-col min-h-screen w-full">
      <div className="w-full bg-white min-h-[4.5rem] sm:min-h-[5rem] flex justify-center items-center sticky top-0 z-10">
        <Header />
      </div>
      ...
      <div className="flex-grow order-2 md:order-3 overflow-auto bg-gray-50">
        <div className="flex container mx-auto px-4 py-4">
           <div className="flex w-[24%] h-full border"></div>
